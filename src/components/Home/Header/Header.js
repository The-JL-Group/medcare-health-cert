        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              {/* Slogan */}
              <h1 className="text-xl tracking-tight font-extrabold drop-shadow-md text-sky-500 sm:text-2xl md:text-3xl font-['Courgette'] italic">
                Where we care
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="rounded-md shadow">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-galleryButton focus:outline-none hover:bg-blue-400 md:py-4 md:text-lg md:px-10"
                  >
                    {' '}
                    Get started{' '}
                  </a>
