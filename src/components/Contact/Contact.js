  ...
  return (
    <div class="container my-24 px-6 mx-auto">
      <section class="mb-32 text-gray-800">
        <div class="contact-image relative overflow-hidden bg-no-repeat bg-cover"></div>
        <div class="container text-gray-800 px-4 md:px-12">
          <div class="contact-image-2 block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="flex items-start">
                      ...
                      <div class="grow ml-6">
                        ...
                        <p class="text-gray-500">
                          Have anything you'd like to know from our Team? Email
                  ...
                  <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                    <div class="flex items-start">
                      ...
                      <div class="grow ml-6">
                        <p class="font-bold mb-1">Text Us</p>
                        <p class="text-gray-500">
                          Need a 1-on-1 talk directly? You can text our student
                          hotline number.
                        </p>
                        <p class="text-gray-500">404-944-2346</p>
                      </div>
                    </div>
                  </div>
                  <div class="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                    <div class="flex align-start">
                      ...
                      <div class="grow ml-6">
                        <p class="font-bold mb-1">Find Us</p>
                        <p class="text-gray-500">
                          Come check out our facility. New students are always
                          welcome!
                        </p>
                        <p class="text-gray-500">
