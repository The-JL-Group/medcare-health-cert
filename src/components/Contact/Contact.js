        ...
        <div class="bg-amber-50">
          <div class="py-20 lg:py-28">
            <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              <h1 class="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl font-[Inter]">
                Contact Us
              </h1>
              {/* Slogan */}
              <h2 class="block text-3xl drop-shadow-md text-sky-500 font-['Courgette'] italic p-2">
                Where we care
              </h2>
